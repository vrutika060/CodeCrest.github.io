...
// import videoFile from "../assets/vediohome.mp4"; // Correct import path
...
//       {/* Overlay Content */}
//       <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center text-center bg-black bg-opacity-50">
...
//       {/* Video Background */}
//       <video
//         className="absolute top-0 left-0 w-full h-[95%] object-cover" // Reduced height to 70%
//         src={videoFile}
//         autoPlay
//         loop
//         muted
...
//       {/* Video Background */}
//       <video
//         className="absolute top-0 left-0 w-full h-full object-cover" // Ensures video covers entire screen
//         src={videoFile}
//         autoPlay
//         loop
//         muted
